...
{/* --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */}
                <div className='welcomesection'>
                    <h1 className='welcometext'>Welcome to Alimente</h1>
                    <p className='carpediemtext'>Alimente is the best way to find local restaurants that deliver to you or quickly order food online. Whether looking for breakfast, lunch, dinner or late night snack, we have it all.</p>
                    <div className='ingredient1'>
                        <img alt='homeimg' src='./images/ingredientsimg1.png' className='ingredientsimg1'/>
                        ...
                        <Link to='/menu'><button className='viewmenu' onClick={()=>window.scrollTo(0,0)}>View Menu</button></Link>
                    </div>
                    <div className='ourservicesection'>
                        <div>
                            ...
                            <Link to='/userprofile'><button className='viewmenu2' onClick={()=>window.scrollTo(0,0)}>Give Reviews</button></Link>
                        </div>
                        <img alt='homeimg' src='./images/chef.png' className='chefimg'/>
                    </div>
                </div>
{/* --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */}
...
{/* --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */} 
                <div className='howwework'>
                    ...
                    <p className='weworkingtext'>How are we Working</p>
                    <p className='weworkingtext2'>If you are looking for a reliable and quality food supplier, pay attention to our company. Everything is very simple! You choose the meal plan that suits you, pay, and we deliver your meal.</p>
                    <div className='allcircles'>
                        <div>
                            <div className='circle circlepos1'>
                        ...
                        <div>
                            <div className='circle circlepos2'>
                        ...
                        <div>
                            <div className='circle circlepos3'>
...
{/* --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */}                          
                <div className='loginsection'>
                        <div className='loginforminhomepage'>
