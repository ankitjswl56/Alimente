    ...
    return(
        <div className='aboutus'>
            <div className='aboutusimgsection'>
                ...
                <p className='aboutusimgtxt'>We are proud <br/> to serving for you</p>
            </div>
            <div className='whoarewe'>
                <p className='whoarewetext '>WHO ARE WE</p>
                <div className='fewwords'>
                    <img alt='aboutusimg' src='./images/whoarewe.png' className='whoareweimg'/>
                    <div>
                        <p className='fewwordstxt1'>A FEW WORDS ABOUT US</p>
                        <p className='fewwordstxt2'>When visiting our restaurant, just brace yourself to immersing into enjoying a truly delicious and perfectly cooked dishes. <br/><br/>The world-renowned chef showcases exhilarating interpretations of European food in a breathtaking space architect Tadao Ando built as a respite from the non-stop chaos of our City.</p>
                    </div>
                </div>
            </div>
            <div className='ourpromises'>
                ...
                <div className='fewwords'>
                <div>
                    <p className='fewwordstxt1 safeppromise'>A PROMISE FOR SAFETY</p>
                    <p className='promisetxt'>We will continue to be a leader in safe sanitation practices with all team members certified in
